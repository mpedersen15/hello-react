...
/***/ function(module, exports, __webpack_require__) {
	...
	var firstName = "Jen";
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: 'An alternative message' }), document.getElementById('app'));
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement('textarea', { ref: 'message', placeholder: 'Enter a message' })
				),
				React.createElement(
					'button',
					null,
